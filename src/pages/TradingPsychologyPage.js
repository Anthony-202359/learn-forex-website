      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            Trading psychology is the emotional component of investing and trading. It determines how you handle risk, stress, and decision-making.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Control emotions: fear, greed, hope, regret</li>
            <li>Stick to your trading plan</li>
            <li>Practice discipline and patience</li>
            <li>Learn from mistakes, avoid revenge trading</li>
          </ul>
        </div>
      </div>
