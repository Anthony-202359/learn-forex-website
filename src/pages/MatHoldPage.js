...
export default function MatHoldPage() {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A bullish continuation pattern with a brief consolidation before the trend resumes.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears in an uptrend</li>
            <li>Brief pause or pullback</li>
            <li>Trend resumes after consolidation</li>
          </ul>
        </div>
      </div>
