    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <BulletPoint text="Support = floor, Resistance = ceiling" fontSize={18} />
          <BulletPoint text="Breakouts above resistance or below support can signal strong moves" fontSize={18} />
        </div>
      </div>
