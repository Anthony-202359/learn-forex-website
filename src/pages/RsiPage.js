      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            The Relative Strength Index (RSI) oscillates between 0-100 to measure overbought (&gt;70) and oversold (&lt;30) conditions. Divergences between RSI and price can signal reversals. The chart shows RSI rising with price and falling with declines. RSI is best used with trend indicators for confirmation and to avoid false signals.
          </div>
        </div>
      </div>
