    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img
            src={'/assets/images/parabolic.jpeg'}
            alt="Parabolic SAR"
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            The Parabolic SAR (Stop and Reverse) plots dots above/below price to signal trend direction and potential reversals. Dots below price = uptrend, above = downtrend. The chart shows how SAR flips sides at reversals. SAR works best in trending markets and is less reliable in choppy conditions. Use SAR with other indicators for confirmation and to set trailing stops.
          </div>
        </div>
      </div>
