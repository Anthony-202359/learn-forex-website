...
export default function DojiPage({ onBack }) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            Open and close are virtually equal, forming a cross or plus sign. Indicates indecision in the market.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears after a trend</li>
            <li>Indicates indecision</li>
