    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img
            src={'/assets/images/percent.jpeg'}
            alt="PPO"
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            The Percentage Price Oscillator (PPO) is similar to MACD but expresses the difference between two EMAs as a percentage. PPO is useful for comparing momentum across assets of different prices. Crossovers and divergences work like MACD. The chart shows PPO line, signal line, and histogram. PPO is best used for momentum and trend confirmation.
          </div>
        </div>
      </div>
