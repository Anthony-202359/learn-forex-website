...
export default function HighWavePage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/highwave.jpeg" 
            alt="High Wave Pattern" 
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            Candles with very long upper and lower shadows relative to the body, showing high volatility and indecision.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears after a trend</li>
            <li>Indicates high volatility and indecision</li>
            <li>Confirmation: next candle closes in direction of breakout</li>
          </ul>
        </div>
      </div>
