    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img
            src={'/assets/images/bollinger.jpeg'}
            alt="Bollinger Bands"
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            Bollinger Bands consist of a moving average (middle band) and two standard deviation bands (upper/lower). Bands expand during high volatility and contract during low volatility. Price touching the upper band can signal overbought, lower band oversold. Squeezes (narrow bands) often precede breakouts. The chart shows how bands adapt to volatility. Bollinger Bands are best used with other indicators for confirmation.
          </div>
        </div>
      </div>
