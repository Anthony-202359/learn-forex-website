...
export default function ShootingStarPage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/shooting.jpeg" 
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            Small body near the low with a long upper shadow, appearing after an uptrend. Signals a potential reversal.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears after an uptrend</li>
            <li>Long upper shadow, small real body</li>
