...
export default function BullishEngulfingPage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/bullisheng.jpeg" 
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A green candle completely engulfs the previous red candle, signaling a potential reversal to the upside.
          </div>
