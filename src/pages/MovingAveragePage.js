      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            The Moving Average (MA) smooths price data to identify the direction of the trend. Simple MA (SMA) gives equal weight to all prices, while Exponential MA (EMA) gives more weight to recent prices. MAs are used to spot trend direction, support/resistance, and crossovers for entry/exit signals. The chart shows how the MA follows price. MAs work best in trending markets and are less useful in choppy conditions.
          </div>
        </div>
      </div>
