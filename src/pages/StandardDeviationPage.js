      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            Standard Deviation measures price volatility by showing how much prices deviate from their average. High values (peaks in the chart) indicate high volatility, while low values show stable periods. This indicator helps identify when markets are unusually volatile or quiet compared to their normal behavior. Traders often combine it with mean-reversion strategies, looking for prices to return to the mean after extreme deviations. The indicator is also used in constructing Bollinger Bands.
          </div>
        </div>
      </div>
