      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 20, fontWeight: 500, marginBottom: 24 }}>
            Fundamental analysis studies economic, social, and political factors that affect currency value.
          </div>
          <div style={{ fontSize: 22, fontWeight: 'bold', color: 'purple', marginBottom: 8 }}>
            Key Factors:
          </div>
          <BulletPoint text="Interest rates" fontSize={18} />
          <BulletPoint text="Inflation" fontSize={18} />
          <BulletPoint text="GDP growth" fontSize={18} />
          <BulletPoint text="Employment data" fontSize={18} />
          <BulletPoint text="Geopolitical events" fontSize={18} />
        </div>
      </div>
