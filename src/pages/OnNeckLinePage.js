...
export default function OnNeckLinePage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/thrusting.jpeg" 
            alt="Thrusting Pattern" 
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A bearish continuation pattern where the second candle opens below the previous low and closes near the prior low, but not below it.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears in a downtrend</li>
            <li>Second candle closes near prior low, but not below</li>
            <li>Indicates continued bearish pressure</li>
          </ul>
        </div>
      </div>
