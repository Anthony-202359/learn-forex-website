...
export default function SeparatingLinesPage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/seperating.jpeg" 
            alt="Separating Lines Pattern" 
            style={{ display: 'block', margin: '0 auto 24px auto', width: '100%', maxWidth: '100%', borderRadius: '16px', boxShadow: '0 2px 8px #0002' }}
          />
          <div style={{ fontSize: 24, fontWeight: 'bold', color: 'purple', marginBottom: 16 }}>
            Separating Lines Pattern
          </div>
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A two-candle continuation pattern where the second candle opens at the same price as the first and continues the trend.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears in a trend</li>
            <li>Second candle opens at same price as first</li>
            <li>Indicates continuation of the trend</li>
          </ul>
        </div>
      </div>
