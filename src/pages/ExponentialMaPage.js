...
export default function ExponentialMaPage() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img
            src={'/assets/images/exponential.jpeg'}
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            The Exponential Moving Average (EMA) gives more weight to recent prices, making it more responsive to new information than a simple moving average. EMAs are used to identify trend direction and potential reversals. Crossovers of short and long EMAs can signal entries/exits. The chart shows how the EMA hugs price more closely than a simple MA. EMAs are popular for trend-following strategies and work well in trending markets.
          </div>
        </div>
      </div>
