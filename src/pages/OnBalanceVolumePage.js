...
export default function OnBalanceVolumePage() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img
            src={'/assets/images/volume.jpeg'}
            alt="On Balance Volume"
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            On Balance Volume (OBV) uses volume flow to predict price changes. Rising OBV confirms uptrends, falling OBV confirms downtrends. Divergences between OBV and price can signal reversals. The chart shows how OBV rises with price and falls with declines. OBV is best used with price action and other indicators for confirmation.
          </div>
        </div>
      </div>
