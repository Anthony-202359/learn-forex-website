...
export default function TasukiGapPage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/tasuki.jpeg" 
            alt="Tasuki Gap Pattern" 
            style={{ display: 'block', margin: '0 auto 24px auto', width: '100%', maxWidth: '100%', borderRadius: '16px', boxShadow: '0 2px 8px #0002' }}
          />
          <div style={{ fontSize: 24, fontWeight: 'bold', color: 'green', marginBottom: 16 }}>
            Tasuki Gap Pattern
          </div>
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A continuation pattern where a gap is followed by two candles in the same direction, then a candle in the opposite direction that does not fill the gap.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears in a trend</li>
            <li>Gap followed by two candles in same direction</li>
            <li>Third candle in opposite direction, but gap remains unfilled</li>
          </ul>
        </div>
      </div>
