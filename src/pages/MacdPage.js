      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            Moving Average Convergence Divergence (MACD) consists of: (1) MACD line (12-day EMA minus 26-day EMA), (2) Signal line (9-day EMA of MACD), and (3) Histogram (difference between MACD and Signal). In the chart, positive histogram bars (green) indicate bullish momentum, while negative (red) show bearish momentum. Crossovers above/below the zero line suggest trend changes. Divergences between price and MACD can signal reversals.
          </div>
        </div>
      </div>
