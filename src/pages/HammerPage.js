...
export default function HammerPage({ onBack }) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            Small body near the top with a long lower shadow, appearing after a downtrend. Signals a potential reversal.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears after a downtrend</li>
            <li>Long lower shadow, small real body</li>
            <li>Confirmation: next candle closes higher</li>
          </ul>
        </div>
      </div>
