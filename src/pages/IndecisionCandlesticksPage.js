...
function PatternItem({ name, description, onClick }) {
  return (
    <div
      onClick={onClick}
      style={{
    ...
    >
      <div style={{ fontSize: 20, fontWeight: 'bold', color: 'purple' }}>{name}</div>
      <div style={{ height: 8 }} />
...
export default function IndecisionCandlesticksPage({ onPatternSelect }) {
