      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 20, fontWeight: 500, marginBottom: 24 }}>
            In Forex, you can profit from both rising (long) and falling (short) markets.
          </div>
          <div style={{ fontSize: 22, fontWeight: 'bold', color: 'purple', marginBottom: 8 }}>
            Going Long:
          </div>
          <ul style={{ fontSize: 18, marginBottom: 16 }}>
            <li>Buy the base currency, sell the quote currency.</li>
            <li>Profit if the pair's price rises.</li>
          </ul>
          <div style={{ fontSize: 22, fontWeight: 'bold', color: 'purple', marginBottom: 8 }}>
            Going Short:
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Sell the base currency, buy the quote currency.</li>
            <li>Profit if the pair's price falls.</li>
          </ul>
        </div>
      </div>
