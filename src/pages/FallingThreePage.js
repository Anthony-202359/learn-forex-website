...
export default function FallingThreePage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/falling.jpeg" 
            alt="Falling Three Pattern" 
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A bearish continuation pattern with three small upward candles between two large downward candles.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears in a downtrend</li>
            <li>Three small up candles between two large down candles</li>
            <li>Indicates continuation of the downtrend</li>
          </ul>
        </div>
      </div>
