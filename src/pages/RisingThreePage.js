...
export default function RisingThreePage() {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/rising.jpeg" 
            alt="Rising Three Pattern" 
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A bullish continuation pattern with three small downward candles between two large upward candles.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears in an uptrend</li>
            <li>Three small down candles between two large up candles</li>
            <li>Indicates continuation of the uptrend</li>
          </ul>
        </div>
      </div>
