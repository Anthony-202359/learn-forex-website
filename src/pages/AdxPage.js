      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, color: '#222', lineHeight: 1.5, textAlign: 'center' }}>
            The Average Directional Index (ADX) measures trend strength from 0-100, regardless of direction. Values above 25 indicate strong trends, below 20 weak trends. The chart shows +DI (green) and -DI (red) lines that identify trend direction when they cross. ADX alone doesn't show direction - combine with +DI/-DI. Peaking ADX often precedes reversals. This indicator works best for confirming whether a market is trending before applying trend-following strategies.
          </div>
        </div>
      </div>
