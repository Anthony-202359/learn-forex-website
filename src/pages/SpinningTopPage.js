...
export default function SpinningTopPage({ onBack }) {
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <img 
            src="/assets/images/spinning.jpeg" 
            alt="Spinning Top Pattern" 
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            Small body with upper and lower shadows of approximately equal length, indicating indecision.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears after a trend</li>
            <li>Indicates market indecision</li>
