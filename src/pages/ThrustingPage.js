...
export default function ThrustingPage() {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            A bearish continuation pattern where the second candle opens below the previous low and closes within the prior body, but not above the midpoint.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Appears in a downtrend</li>
            <li>Second candle closes within prior body, but below midpoint</li>
