...
export default function TechnicalAnalysisPage({ onNavigate }) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: 18, fontWeight: 500, marginBottom: 24 }}>
            Technical analysis uses historical price and volume data to forecast future price movements. It is essential for timing entries and exits.
          </div>
          <ul style={{ fontSize: 18 }}>
            <li>Focuses on price charts and indicators</li>
            <li>Identifies trends and patterns</li>
            <li>Used for timing entries and exits</li>
          </ul>
        </div>
      </div>
